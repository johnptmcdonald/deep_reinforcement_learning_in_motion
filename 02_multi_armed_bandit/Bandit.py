...
if __name__ == '__main__':
	...
	run2 = simulate(numArms, epsilon=0.01, numPulls=1000)
	run3 = simulate(numArms, epsilon=0.0, numPulls=1000)

	plt.plot(run1, 'b--', run2, 'r--', run3, 'g--')
	plt.legend('epsilon=0.1', 'epsilon=0.01', 'epsilon=0.1, pure greedy')
	plt.show()
